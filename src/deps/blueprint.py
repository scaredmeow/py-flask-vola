...
def register_blueprints(app: Flask):
    ...
    from src.py_flask_vola.routers.api import auth, users, social, teams,sports
    ...
    app.register_blueprint(sports.app, name="Sports", url_prefix=f"{api_url_prefix}/sports")
